...
public class CustDashboardPage extends LoadableComponent<CustDashboardPage> {
  ...
  List<WebElement> viewbuttonscount =null;
  ...
  public String mtaStartDate = "#C2__C6__QUE_4F6C7E1EA3A0DE0E1111397";
  public String staStartDate = "#C2__C6__QUE_4E9E6DEC4AB0C369160959";
  public String baStartDate = "input[id*='2F09F20DA3B36B74205865']";
  public String staExpiryDate_new = "#C2__C6__QUE_4E9E6DEC4AB0C369160965";
  ...
  public String staExpiryDate = "#C2__C6__QUE_4E9E6DEC4AB0C369160965";
  ...
  @FindBy(css = "div[id*='FMT_9AF9ECE9A7A9E74D1066716']")
  WebElement popup_STA;
  @FindBy(css = "input[placeholder='Start Date'][type='text']")
  WebElement datePicker;

  @FindBy(css = "#QUE_8D734F2AC91F8FEB325795")
  ...
  @FindBy(css = "#C2__C6__FMT_7521276D4111CE32862029 > div > div.modal-header.modal-title")
  WebElement MTAPopUp;

  //@FindBy(css = "div[id*='4E9E6DEC4AB0C369161075']")
  @FindBy(css = "#C2__C6__FMT_BFCE50661BFE169C3081830 > div > div.modal-header.modal-title")
  WebElement STAPopUp;
  ...
  @FindBy(css = "#C2__C6__QUE_4E9E6DEC4AB0C369160971")
  ...
  @FindBy(css = "span[id*='a_viewPolicy']")
  WebElement tab_viewPolDetailsselect;


  //@FindBy(css = "#finance")
  @FindBy(css = "#C2__C6__ITM_32BF5DA7372009F11482905")
  ...
  @FindBy(css = "div[id*='ITM_97C78E9B190E52CA833600']")
  ...
  @FindBy(css = "span[id*='QUE_24F4D09ABF5D5E60315870']")
  ...
  @FindBy(css = "span[id*='QUE_24F4D09ABF5D5E60315872']")
  ...
  @FindBy(css = "#C2__C6__BUT_758B1448D2A3095B454380")
  WebElement btnshtTermContinue;

  @FindBy(css = "#C2__C6__QUE_4F6C7E1EA3A0DE0E1111397")
  WebElement txtMidTermDate;
  @FindBy(css = "#C2__C6__QUE_4E9E6DEC4AB0C369160959")
  WebElement txtshtTermDate;

  @FindBy(css = "div[for*='C2__C6__QUE_4F6C7E1EA3A0DE0E1111397'] .glyphicon-calendar")
  ...
  @FindBy(css = "#C2__C6__QUE_4E9E6DEC4AB0C369160971")
  WebElement cmbshortTermAdjReason;
  @FindBy(css = "#C2__C6__QUE_4F6C7E1EA3A0DE0E1111400")
  WebElement cmbMidTermAdjReason;
  @FindBy(css = "#C2__C6__QUE_4E9E6DEC4AB0C369160971")
  WebElement cmbSHTTermAdjReason;
...
//div.main-brand
  @FindBy(css = "#img_C1__TXT_C99AAF40EE7EDAD4619412")
  ...
  @FindBy(css = "#C2__C6__Menu_InviteRenewals")
  ...
  @FindBy(css = "#C2__C6__navdrop > div > div > ul > li.dropdown.renewal-quote.drop-inline.dropdown-hover.open > ul > li > a > span.col-md-6.col-sm-6.noPadRht")
  ...
  @FindBy(css = "#C2__C4__p4_QUE_3B87415692E0F10617444_R1 > span:nth-child(1) > span")
  ...
  @FindBy(css="div[id*='HEAD_1276719E6EB892F83061163']")
  ...
  @FindBy(css = "#C2__C6__MenuCancelCoolingOff")
  WebElement datePicker_STA;
  
  @FindBy(css = "#C2__C6__p4_QUE_726A765E51D907DB261850 > div > div")
  WebElement txtIPName; 
   ...
   * 
   */
  public void clickshortTermAdjustment(ExtentTest extentedReport) throws Exception {
    try {
      WaitUtils.waitForElement(driver, shortTermAdj);
      shortTermAdj.click();
      WaitUtils.waitForElement(driver, txtshtTermDate);
      Log.message("Clicked on short Term Adjustment", driver, extentedReport, true);
    } catch (Exception e) {
      throw new Exception("Unable to click on short Term Adjustment Button : " + e);
    }
  }
  /**
  ...
  public void selectshortTermAdjReason(String STAcreationReason, ExtentTest extentedReport)
      throws Exception {
    try {

      Select titledrpDown = new Select(cmbshortTermAdjReason);
      titledrpDown.selectByVisibleText(STAcreationReason);
      Thread.sleep(2000);
      Log.message("Selected MidTerm Reason : " + STAcreationReason, driver, extentedReport);
    } catch (Exception e) {
      throw new Exception("Date is not entered : " + e);
    }
  }
  ...
  public void selectSTATermAdjReason(String STAcreationReason, ExtentTest extentedReport)
      throws Exception {
    try {

      Select titledrpDown = new Select(cmbSHTTermAdjReason);
      titledrpDown.selectByVisibleText(STAcreationReason);
      Thread.sleep(2000);
      Log.message("Selected Short Term Reason : " + STAcreationReason, driver, extentedReport);
    } catch (Exception e) {
      throw new Exception("Date is not entered : " + e);
    }
  }
  ...
  public void clickshortTermContinue(ExtentTest extentedReport) throws Exception {
    try {
      WaitUtils.waitForElement(driver, btnshtTermContinue);
      btnshtTermContinue.click();
      WaitUtils.waitForSpinner(driver);
      Log.message("shortTerm Continue button clicked", driver, extentedReport);
    } catch (Exception e) {
      throw new Exception("Short Term Continue button not clicked : " + e);
    }
  }
  /**
   * To click BuyMTA
  ...
  public void enterEffectiveDate() throws Exception {
    try {
      ...
      // By.cssSelector("#QUE_8D734F2AC91F8FEB325795")));
  ...
  public boolean clickdocViewbtn(String Policynum, ExtentTest extentedReport) throws Exception {
    ...
    // List  <WebElement >element = driver.findElements(By.cssSelector("#C2__C6__TBL_BD388A52554BC5E72766684 >tbody > tr> td> div a"));

    // viewbuttonscount=element;
  viewbuttonscount = driver.findElements(By.cssSelector("#C2__C6__TBL_BD388A52554BC5E72766684 >tbody > tr> td> div a"));

  Log.message("view button count "+viewbuttonscount.size());
...
//
    ...
    try {
     WaitUtils.waitForElementPresent(driver, 40, STAPopUp,
      ...
      new WebDriverWait(driver, 120).pollingEvery(200, TimeUnit.MILLISECONDS).until(
          ExpectedConditions.visibilityOf(driver.findElement(By.cssSelector(staExpiryDate_new))));
      
      
      WebElement staExpiryDateEletest = driver.findElement(By.cssSelector(staExpiryDate));
      EnterExpiryDateOnWind(staExpiryDateEletest, true);
      Thread.sleep(1000);

      selectSTAReason(testdata.get("AdjustmentReason_STA"));
      Thread.sleep(1000);
  ...
  public void EnterExpiryDateOnWind(WebElement ElementToInteract, boolean Screenshot)
      throws Exception {
    try {
      WaitUtils.waitForElementPresent(driver, 129, ElementToInteract,
          "Failed to click on MTA date field");
      SimpleDateFormat format = new SimpleDateFormat("dd/MM/yyyy");
      Calendar calobj = Calendar.getInstance();
      calobj.add(Calendar.DAY_OF_MONTH, 60);
      String effectDate = format.format(calobj.getTime()).toString();
      new WebDriverWait(driver, 1000).pollingEvery(200, TimeUnit.MILLISECONDS)
          .until(ExpectedConditions.visibilityOf(ElementToInteract));
      ElementToInteract.sendKeys(effectDate);
  ...
  public HashMap<String, String> getPolicyURN(ExtentTest extentedReport) throws Exception {
    try {
      ...
      System.out.println("the size-------------------------"+tbl_Policydetails.size());
      ...
      hmpolDetails.put("notification_plcy",
          GenericUtils.getTextOfWebElement(tbl_Policydetails.get(9), driver));
      System.out.println("the size-------------------------"+tbl_Policydetails.size());
   ...
   * @param Screenshot
   * @throws Exception as custom Exception Message
   * #C2__C6__ITM_97C78E9B190E52CA833600
   */
  ...
  public void selectMenu_from_policyDetails_tab(String valToSelect, ExtentTest extentedReport,
    ...
    try {
      ...
      if (valToSelect.equalsIgnoreCase("Policy cover"))
        ...
        tab_viewPolDetailsselect.click();
...
//
  ...
  public boolean validatePolicyStatus(ExtentTest extentedReport,boolean flag)
      throws Exception {
    flag = false;
    try {
      WaitUtils.waitForSpinner(driver);
      ...
      if(status.contentEquals("Cancelled"))
          {
        Log.pass("Policy is cancelled", extentedReport);
      }
      else 
      {
        Log.fail("Policy has not been cancelled");
      }
      return flag;
    } catch (Exception e) {
      throw new Exception("Unable to click on Cancel Policy tab :" + e);
  ...
  public void setExpirydateforSTA(HashMap<String, String> testdata, boolean Screenshot,
      ExtentTest extentReport) throws Exception {
    try {

     
      String strDate = GenericUtils.setDate("current", datePicker_STA, 50, 0);
      datePicker_STA.click();
      Log.message("Entered Date : " + strDate, extentReport);
  ...
  public boolean verifyIPName(String name, ExtentTest extentReport, boolean Screenshot)
      throws Exception {
    try {
      boolean status = false;
      String ipName = txtIPName.getText();
      Log.message("IP name on dashboard is available : " + ipName+"  Existing Name : "+ name, driver,
          extentReport, Screenshot);
      if (ipName.trim().equalsIgnoreCase(name)) {
        Log.message("IP name on dashboard is available : " + ipName+"Existing Name : "+ name, driver,
            extentReport, Screenshot);
        
        status = true;
      }else {
        Log.fail("IP name verification on dashboard failed " ,driver, extentedReport, true);
        throw new Exception("Verification of IP Name On Dashboard Failed");
      }
      Log.event("Verified IP name on dashboard");
      return status;
    } catch (Exception e) {
      throw new Exception("Verification of IP Name On Dashboard Failed" + e);
    }
