...
public class HomePage extends LoadableComponent<HomePage> {
  ...
  @FindBy(css = "#C1__ITM_5866E32A0412B1F918365")
  ...
  @FindBy(css = "input[name='C1__CONTACTCENTRE[1].LOGIN[1].USERNAME_READONLY']")
  ...
  @FindBy(css = "a[id='C2__C1__FMT_E6EC838EC687744D875884']")
  WebElement mdlMyBrndsCloseBtn;

  //@FindBy(css = "button[title='Cancel']")
  @FindBy(css = "#C2__C1__BUT_874EFCFEFA062832841943")
